//! Typed client SDK for The Big Computer engine (M17–M18).
//!
...
pub use tbc_engine::consent_wire::{consent_from_payload, verify_consent_stamp, WireConsentStamp};
...
pub use tbc_engine::transport::{
    ...
    wire_to_intent, WireMessage, WIRE_MAGIC,
};
...
mod wire_tests {
    ...
    fn assist_wire_roundtrip() {
        let msg = WireMessage::assist(42, Some(7), None);
